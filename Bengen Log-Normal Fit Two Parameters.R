...
yy <- ggplot(data = c.df, aes(x = xx.breaks.2.36., y = acc_sum)) + geom_line() +
xlab("Years in Retirement") + ylab(paste("Number of Failed Portfolios of ",n)) +
theme_gray() + ggtitle(paste("Number of Ruined Portfolios per \n",n," with ",normalspend/portfolio*100,"% Annual Withdrawals",sep=""))
